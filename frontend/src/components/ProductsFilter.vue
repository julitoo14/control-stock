<template>
  ...
  <div class="mb-4 flex flex-wrap items-center gap-4">
    ...
    <select v-model="selectedCategory"
      class=" text-gray-300 rounded px-3 py-2 bg-gray-800 dark:text-gray-100 dark:bg-gray-800"
      @change="search">
    ...
    <input v-model="searchQuery" type="text" placeholder="Buscar productos"
      class=" text-gray-300 rounded px-3 py-2 bg-gray-800 dark:text-gray-100 dark:bg-gray-800 flex-1"
      @input="search" />

    <button @click="clearFilters" class="bg-gray-800 hover:bg-blue-900 text-white px-4 py-2 rounded">
      Limpiar
    </button>

    <router-link to="/productos/guardar" class="bg-gray-800 hover:bg-blue-900 text-white px-4 py-2 rounded">
      Agregar producto
    </router-link>
